<footer class="container-fluid">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<h3>Escribenos:</h3>
			<i class="fa fa-at"></i> <a href="#">CCB@gmail.com</a>
		</div>
	</div>
</footer>