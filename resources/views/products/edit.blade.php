                    ...
                    <div class="card-body">
                        {!! Form::open(['route'=>['productos.update', $productos], 'method' => 'PUT']) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $productos->name }}" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="slug" type="text" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" value="{{ $productos->slug }}" value="{{ old('slug') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="extract" type="text" class="form-control{{ $errors->has('extract') ? ' is-invalid' : '' }}" name="extract" value="{{ $productos->extract }}" value="{{ old('extract') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ $productos->price }}" value="{{ old('price') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="image" type="text" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" value="{{ $productos->image }}" value="{{ old('image') }}" required autofocus>
