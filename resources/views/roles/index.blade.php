        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="product-block">
                    ...
                    <div class="card-header" align="center"><h1><span class="badge badge-light">  <i
                                        class="fa fa-user-tag"> </i>  LISTADO ROLES</span></h1></div>
                    <br>

                    <div class="container" align="center">
                        <a href="{{ route('roles.create') }}" class="btn btn-success btn-block"
                           style="justify-content-right"> <i class="fa fa-plus-square" style="font-size:20px"></i> </a>
                        <hr>
                    </div>
                        ...
                        <table class="table table-striped   table-responsive table-hover" class="justify-content-center"
                            ...
                            @foreach($roles as $roles)
                                <tr>
                                    ...
                                    <TD>
                                        <a href="{{ route('roles.index.edit', $roles->id) }}" class="btn btn-warning">
                                            <i class="fa fa-edit" style="font-size:12px"></i> </a>

                                        <a href="{{ route('roles.index.destroy' , $roles->id) }}"
                                           onclick="return confirm('¿Eliminar Rol?')" class="btn btn-danger">
